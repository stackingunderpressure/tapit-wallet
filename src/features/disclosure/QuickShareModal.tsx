          ...
          <>
            ...
            {anchor?.proof && (
              <button
                ...
                className="mt-3 w-full rounded-2xl border border-fresh-surface-edge bg-fresh-surface-glass py-2.5 text-xs font-medium text-fresh-text-primary backdrop-blur-xl"
              >
