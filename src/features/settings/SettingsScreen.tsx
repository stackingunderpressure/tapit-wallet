    ...
    <div className="min-h-screen p-5 max-w-md mx-auto">
      ...
      <section className="mt-4 rounded-2xl bg-amber-50/40 border border-amber-200 p-5">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            <div className="text-sm font-medium">
              Paper recovery key as last-resort backup
            </div>
            <p className="mt-1 text-xs text-muted">
              For operators who keep everything local and never connect to
              the network, the cohort cascade does not apply. A future
              "write down a recovery key once and store it safely" feature
              will close that gap unconditionally. Until then, the
              passphrase plus the local-backup file download are the
              offline-only path back.
            </p>
          </div>
        </div>
      </section>
