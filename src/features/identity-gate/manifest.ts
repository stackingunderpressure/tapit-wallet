...
export const manifest: FeatureManifest = {
  ...
  touches: [
    ...
    'src/features/identity-gate/gatedReleaseBundle.ts',
    'src/features/identity-gate/gatedReleaseBundle.test.ts',
  ],
